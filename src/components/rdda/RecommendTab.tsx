...
export function RecommendTab({ report }: { report: RddaReportV2 }) {
  ...
  return <div className="space-y-4">
    ...
    <KpiGrid items={[{ label: "제안 후보", value: data.candidates.toLocaleString() }, { label: "팀 픽업률", value: `${data.teamPickRate.toFixed(1)}%` }, { label: "전체 픽업률", value: `${data.allPickRate.toFixed(1)}%` }, { label: "팀 우위", value: `${(data.teamPickRate - data.allPickRate).toFixed(1)}%p` }]} />

...
export function RequestBoardHeader({ board, styles, stageOf, canManage, onEdit, onCloseBoard }: {
  board: RequestBoard; styles: readonly RequestStyle[]; stageOf: (option: RequestOption) => ProcessStage; canManage: boolean; onEdit: () => void; onCloseBoard: () => void
}) {

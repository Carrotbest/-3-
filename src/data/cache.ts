...
export const CACHE_KEYS = ["records", "completed", "meta", "study", "studyFiles", "events", "rdda", "fabricAnalysis", "ts", "orgMembers", "materials", "materialsManual", "materialDiagnostics", "fabricOverrides", "fabricEvents", "chemical", "chemicalManual", "chemicalLinks", "requests", "requestBoards", "requestArchive", "disposalRounds", "rddaSnapshots", "rddaReports", "analysisRequests"] as const

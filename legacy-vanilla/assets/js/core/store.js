...
export function applyTheme(theme) {
  ...
  try { localStorage.setItem('fabric.theme', t); localStorage.setItem('fabric.theme.lightstudio', t); } catch { /* 시크릿 모드 */ }
  store.set({ theme: t });
}

export function initTheme() {
  let saved = null;
  try { saved = localStorage.getItem('fabric.theme.lightstudio'); } catch { /* noop */ }
